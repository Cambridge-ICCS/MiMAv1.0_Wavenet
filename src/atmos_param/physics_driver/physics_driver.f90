...
use rrtm_radiation
use rrtm_vars     
use prescribed_heating_mod ! kjd: prescribed heating
!-----------------------------------------------------------------
...
logical :: do_gaussian_lat_z_heating = .false.
...
namelist / physics_driver_nml / do_netcdf_restart, do_radiation, &
                                ...
                                do_damping, do_gaussian_lat_z_heating
...
!-----------------------------------------------------------------------
!    initialize prescribed_heating mod 
!-----------------------------------------------------------------------
      if (do_gaussian_lat_z_heating) call prescribed_heating_init
...
!---------------------------------------------------------------------
!    kd: prescribe heating
!---------------------------------------------------------------------
     if (do_gaussian_lat_z_heating) call prescribed_heating(p_full,tdt,lat)
